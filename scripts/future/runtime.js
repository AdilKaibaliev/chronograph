...
futurePanel.innerHTML='<header class="future-head"><div class="future-label">CHRONOGRAPH 1.4.1</div><h2></h2><p></p><div class="future-controls"><select id="futureGroup"></select><input id="futureSearch" type="search" autocomplete="off"></div></header><div class="future-scroll" id="futureScroll"><article id="futureArticle"></article><details class="future-index" open><summary id="futureListTitle"></summary><ol class="future-list" id="futureList"></ol></details><details class="future-method"><summary id="futureMethodTitle"></summary><p id="futureMethodBody"></p><p id="futureMapMethod"></p></details></div>';
