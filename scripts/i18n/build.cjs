...
let html=source.replaceAll('CHRONOGRAPH 1.0 RC3.8','CHRONOGRAPH 1.3.1');
html=html.replace('<html lang="ru">','<html lang="en">').replace(/<title>.*?<\/title>/,'<title>CHRONOGRAPH 1.3.1 · Historical atlas</title>');
